...
class Routes {
  ...
  MaterialPageRoute<dynamic> generateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case phoneScreen:
        return MaterialPageRoute<PhoneScreen>(builder: (context) => const PhoneScreen());
      case recently:
        return MaterialPageRoute<Recently>(builder: (context) => const Recently());
      case register:
        return MaterialPageRoute<Register>(builder: (context) => const Register());
      case otp:
      ...
      case chat:
        return MaterialPageRoute<Chat>(
            builder: (context) => Chat(
                  chatRoom: routeSettings.arguments as List,
                ));
      case profile:
